                  ...
                  <div className="row align-items-center">
                     <div className="col-xxl-3 col-xl-3 col-lg-4 col-md-2 col-sm-4 col-6">
                        <div className="header__left d-flex">
                           <div className="logo">
                              <Link href="/">
                                 <a><img src="assets/img/logo/FirstAid.png" alt="logo" style={image} /></a>
                              </Link>
                           </div>
                     ...
                     <div className="col-xxl-9 col-xl-9 col-lg-8 col-md-10 col-sm-8 col-6">
                        <div className="header__right d-flex justify-content-center align-items-center">
                         ...
                         <Link href="/sign-in"><a className="btn btn-outline-primary btn-lg" style={button}>Login</a></Link>
                           </div>
                            :
                           <div className="header__btn  d-none d-sm-block">
                              <Link href="/sign-in"><a className="btn btn-outline-primary btn-lg" onClick={()=>{sessionStorage.removeItem('token')}} style={button}>logout</a></Link>
                           </div>}
