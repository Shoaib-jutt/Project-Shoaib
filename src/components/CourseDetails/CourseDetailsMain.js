...
class CourseDetailsMain extends Component {
    ...
    componentDidMount() {
		...
		fetch(`${process.env.API_URL}/course/${this.props.id}`, {
			method: 'GET',
			headers: {
                                        ...
                                        <div className="page__title-breadcrumb">                            
                                            <nav aria-label="breadcrumb">
                                                <ol className="breadcrumb">
                                                    ...
                                                    <li className="breadcrumb-item active" aria-current="page">{items[0]['Course'].name} </li>
                                                </ol>
                                            </nav>
                                        </div>
                                    <span className="page__title-pre">Development</span>
                                    <h5 className="page__title-3">{items[0]['Course'].name}</h5>
                                    </div>
                                    ...
                                    <Tabs>
                                        <div className="course__tab-2 mb-45">
                                            <ul className="navs nav-tabss" id="courseTab" role="tablist">
                                                <TabList>
                                                    <Tab>
                                                        <button className="nav-link" type="button" role="tab"><i><FontAwesomeIcon icon={['fas', 'ribbon']} /></i> <span>Discription</span> </button>
                                                    </Tab>
                                                    <Tab>
                                                        <button className="nav-link" type="button"> <i><FontAwesomeIcon icon={['fas', 'book']} /></i> <span>Curriculum</span> </button>
                                                    </Tab>
                                                    <Tab>
                                                        <button className="nav-link" type="button"> <i><FontAwesomeIcon icon={['fas', 'star']} /></i> <span>Reviews</span> </button>
                                                    </Tab>
                                                    <Tab>
                                                        <button className="nav-link" type="button"> <i><FontAwesomeIcon icon={['fas', 'user']} /></i> <span>Members</span> </button>
                                                    </Tab>
                                                </TabList>
                                            </ul>
                                        </div>
                                            ...
                                            <div className="tab-contents">
                                                <TabPanel>
                                                    <div className="course__description">
                                                        ...
                                                        <p>{items[0]['Course'].description} </p>
                                                                    ...
                                                                    <div className="course__comment-wrapper ml-70 fix">
                                                                        ...
                                                                        <div className="course__comment-rating float-start float-sm-end">
                                                                            <ul>
                                                                                ...
                                                                                <li><a href="#"> <i><FontAwesomeIcon icon={['fas', 'star']} /></i> </a></li>
                                                                                <li><a href="#"> <i><FontAwesomeIcon icon={['fas', 'star']} /></i> </a></li>
                                                                                <li><a href="#" className="no-rating"> <i><FontAwesomeIcon icon={['fas', 'star']} /></i> </a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                    <div className="course__comment-text ml-70">
