                              ...
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       ...
                                       <p><a href="mailto:support@educal.com">support@firstaidmadeeasy.com.pk</a></p>
                                       <p><a href="mailto:info@educal.com"> info@firstaidmadeeasy.com.pk</a></p>
                                    </div>
                                 </div>
                              </li>
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       <h4>Phone</h4>
                                       <p><a href="tel:+(426)-742-26-44">+(92)318-0049742</a></p>
                                       <p><a href="tel:+(224)-762-442-32">+(92)300-7131730</a></p>
                                    </div>
                                 </div>
                              </li>
                           </ul>
