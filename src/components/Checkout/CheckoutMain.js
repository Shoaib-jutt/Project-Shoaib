...
class CheckoutMain extends Component {
    ...
    componentDidMount() {
		...
		fetch(`${process.env.API_URL}/view/cart`, {
			method: 'GET',
			headers: {
    ...
    checkout(){
        fetch(`${process.env.API_URL}/create/order`, {
			method: 'POST',
			headers: {
				'Content-Type': 'application/json'
			}
                                    ...
                                    <div className="your-order mb-30 ">
                                        ...
                                        <div className="payment-method">
                                            ...
                                            <div className="order-button-payment mt-20">
                                                <button type="button" onClick={this.checkout} className="e-btn e-btn-border">Place order</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
